    ...
    <section class="checkout-form">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="display-order">
                ...
                ON a.userId = b.userId JOIN Flight c 
                ON b.flightId = c.flightId WHERE a.userId = $userId";
...
if (isset($_POST['order'])) {
    ...
    $sql = "SELECT * FROM OrderDetails a JOIN Flight b ON a.flightId = b.flightId WHERE a.userId = '$userId'; ";
    $statement = $connection->prepare($sql);
    $statement->execute();
    $statement->setFetchMode(PDO::FETCH_ASSOC);
    $sp = $statement->fetchAll();
    ...
    $flightName = rtrim($flightName, ", ");
    $price = rtrim($price, ", ");
    $quantity = rtrim($quantity, ", ");

    $insert = "INSERT INTO Orders(Id_don_hang, flightName, price, quantity, userId, orderDate, description, price_sum)
